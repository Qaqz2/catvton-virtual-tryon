...
class CatVTONPipeline:
    def __init__(
        ...
        vae_path = vae_ckpt if vae_ckpt else "stabilityai/sd-vae-ft-mse"
        ...
        self.unet = UNet2DConditionModel.from_pretrained(base_ckpt, subfolder="unet", variant="fp16").to(device, dtype=weight_dtype)
    ...
    def __call__(
        ...
        **kwargs
        ...
        latents = randn_tensor(
            masked_latent_concat.shape, generator=generator, device=masked_latent_concat.device, dtype=self.weight_dtype,
        )
